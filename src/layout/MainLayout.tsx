    ...
    return (
      <ProtectedRoute>
          <div className="flex flex-col min-h-screen bg-gray-100">
              ...
              <footer className={`${glassMode ? 'glass-card mx-5 mb-2 top-5' :'w-full bg-white'} flex-row flex-wrap items-center justify-center gap-y-6 gap-x-12 bg-gray p-6 shadow-sm border-t border-gray-500 text-center md:justify-between`}>
